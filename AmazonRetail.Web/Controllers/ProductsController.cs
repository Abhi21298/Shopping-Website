...
namespace AmazonRetail.Web.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Description,UnitPrice,ImageFile,UnitsInStock,Star,Id")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,Description,UnitPrice,ImageFile,UnitsInStock,Star,Id")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
